...
public abstract class PanelSoporteForm extends JPanel {
    ...
    public static enum Tipo{ALTA, MODIFICACION};

    protected PanelSoporteForm(InterfaceModuleController manejadorEventos,
            PanelBotoneraForm panelSur, PanelFormularioForm panelCentral, Tipo tipo) {
    ...
    public PanelBotoneraForm getPanelSur() {
        return panelSur;
    }

    public PanelFormularioForm getPanelCentral() {
        return panelCentral;
    }
