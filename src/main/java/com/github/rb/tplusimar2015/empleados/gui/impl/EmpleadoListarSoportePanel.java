...
public class EmpleadoListarSoportePanel extends PanelSoporteList {

   public EmpleadoListarSoportePanel(InterfaceModuleController controller,
                                  AbstractTableModel modelo){
        
        super(controller, new EmpleadoPanelBotoneraList(),new EmpleadoPanelFormularioList(modelo));
    ...
    protected Empleado prepararDatos() {
       ...
       return  new Empleado(nLegajo, direccion, senority, rol, dniEmpleado, nombre, apellido, telefono);
